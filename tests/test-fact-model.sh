...
accepts "$(gmut 'f["invalidators"]=["issue:github.com/acme/widgets#40"]')" && bad "a graph that does not list the node it was read from as an invalidator must be rejected (R17)" || ok
