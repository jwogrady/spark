...
"""
os.makedirs(os.path.join(W, "docs/research/v0.23-cleanup"), exist_ok=True)
with open(os.path.join(W, "docs/research/v0.23-cleanup/743-responsibilities.tsv"), "w") as fh:
