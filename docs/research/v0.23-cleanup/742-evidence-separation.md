...
every evidence artifact of the repository — 132 files, 1,045,463 bytes, 16,914 lines under
...
|---|---|---|---|
| `active-current` | 52 | 438,758 | 7,170 |
...
| `docs/research/v0.23-cleanup` | 20 | 298,840 | 3,925 |
...
**29 files, 362,853 bytes** of the 132-file, 1,045,463-byte corpus are referenced by code,
