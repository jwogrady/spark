...
every evidence artifact of the repository — 132 files, 1,046,186 bytes, 16,916 lines under
...
|---|---|---|---|
| `active-current` | 52 | 439,481 | 7,172 |
...
**29 files, 363,580 bytes** of the 132-file, 1,046,186-byte corpus are referenced by code,
