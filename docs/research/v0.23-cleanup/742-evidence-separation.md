...
every evidence artifact of the repository — 132 files, 1,042,188 bytes, 16,838 lines under
...
|---|---|---|---|
| `active-current` | 52 | 435,483 | 7,094 |
...
| `docs/research/v0.23-cleanup` | 20 | 295,565 | 3,849 |
...
**29 files, 359,579 bytes** of the 132-file, 1,042,188-byte corpus are referenced by code,
