...
every evidence artifact of the repository — 132 files, 1,047,064 bytes, 16,923 lines under
...
|---|---|---|---|
| `active-current` | 52 | 440,359 | 7,179 |
...
**29 files, 363,580 bytes** of the 132-file, 1,047,064-byte corpus are referenced by code,
