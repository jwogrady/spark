...
every evidence artifact of the repository — 132 files, 1,046,185 bytes, 16,916 lines under
...
|---|---|---|---|
| `active-current` | 52 | 439,480 | 7,172 |
...
| `docs/research/v0.23-cleanup` | 20 | 299,562 | 3,927 |
...
**29 files, 363,579 bytes** of the 132-file, 1,046,185-byte corpus are referenced by code,
