...
every evidence artifact of the repository — 132 files, 1,048,798 bytes, 16,934 lines under
...
|---|---|---|---|
| `active-current` | 52 | 442,093 | 7,190 |
...
**29 files, 366,190 bytes** of the 132-file, 1,048,798-byte corpus are referenced by code,
