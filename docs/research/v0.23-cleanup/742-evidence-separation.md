...
every evidence artifact of the repository — 132 files, 1,048,796 bytes, 16,934 lines under
...
|---|---|---|---|
| `active-current` | 52 | 442,091 | 7,190 |
...
| `docs/research/v0.23-cleanup` | 20 | 299,563 | 3,927 |
...
**29 files, 366,188 bytes** of the 132-file, 1,048,796-byte corpus are referenced by code,
...
Physical, over the same roots, against `b66766a` — the commit this branch left:

| | Files | Bytes | Lines |
|---|---|---|---|
| before | 132 | 1,045,414 | 16,912 |
| after | 132 | 1,048,796 | 16,934 |
| delta | +0 | +3,382 | +22 |
