...
every evidence artifact of the repository — 132 files, 1,048,526 bytes, 16,933 lines under
...
|---|---|---|---|
| `active-current` | 52 | 441,821 | 7,189 |
...
**29 files, 365,918 bytes** of the 132-file, 1,048,526-byte corpus are referenced by code,
