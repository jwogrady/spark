...
every evidence artifact of the repository — 132 files, 1,048,383 bytes, 16,932 lines under
...
|---|---|---|---|
| `active-current` | 52 | 441,678 | 7,188 |
...
**29 files, 365,775 bytes** of the 132-file, 1,048,383-byte corpus are referenced by code,
