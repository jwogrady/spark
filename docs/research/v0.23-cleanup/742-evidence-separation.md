...
every evidence artifact of the repository — 132 files, 1,049,112 bytes, 16,935 lines under
...
|---|---|---|---|
| `active-current` | 52 | 442,407 | 7,191 |
...
**29 files, 366,504 bytes** of the 132-file, 1,049,112-byte corpus are referenced by code,
