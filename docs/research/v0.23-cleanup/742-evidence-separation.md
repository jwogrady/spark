...
every evidence artifact of the repository — 132 files, 1,047,462 bytes, 16,926 lines under
...
|---|---|---|---|
| `active-current` | 52 | 440,757 | 7,182 |
...
**29 files, 364,854 bytes** of the 132-file, 1,047,462-byte corpus are referenced by code,
