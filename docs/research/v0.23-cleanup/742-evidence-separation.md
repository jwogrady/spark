...
every evidence artifact of the repository — 132 files, 1,046,913 bytes, 16,922 lines under
...
|---|---|---|---|
| `active-current` | 52 | 440,208 | 7,178 |
...
**29 files, 363,580 bytes** of the 132-file, 1,046,913-byte corpus are referenced by code,
