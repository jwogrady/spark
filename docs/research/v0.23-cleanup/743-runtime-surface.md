...
| `source-collection` | 86 | 94 | 1,754 | 2,479 | reads a source of truth (git, gh, the filesystem) and returns it unjudged |
...
Module count goes 3 to 4, adding `facts.sh`. The runtime holds 276 functions and 12,241 body lines, against
249 and 10,034 before: +27 functions, +2207 body lines.
...
| `plugins/spark/lib/facts.sh` | 0 | 2,740 | +2740 |
**12,166 lines before, 14,986 after (+2820)**, against
10,034 and 12,241 body lines. Both grow: this tree adds runtime rather than only redistributing it, and the body lines say so rather than being read out of the file total.
...
9,451 of 12,234 body lines. That
