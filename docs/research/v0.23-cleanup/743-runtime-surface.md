...
| `source-collection` | 86 | 92 | 1,754 | 1,871 | reads a source of truth (git, gh, the filesystem) and returns it unjudged |
...
Module count goes 3 to 4, adding `facts.sh`. The runtime holds 262 functions and 10,562 body lines, against
249 and 10,034 before: +13 functions, +528 body lines.
...
| `plugins/spark/lib/facts.sh` | 0 | 801 | +801 |

**12,166 lines before, 13,022 after (+856)**, against
10,034 and 10,562 body lines. Both grow: this tree adds runtime rather than only redistributing it, and the body lines say so rather than being read out of the file total.
...
8,765 of 10,562 body lines. That
...
- **No cleanup-only refactor became a rewrite** — 15 function(s) added, 2 removed, +528 body lines — the shape of an increment, not of a restructuring.
