...
Module count is unchanged at three. The runtime holds 258 functions and 10,183 body lines, against
249 and 10,034 before: +9 functions, +149 body lines.
...
| `plugins/spark/lib/facts.sh` | 0 | 321 | +321 |

**12,166 lines before, 12,542 after (+376)**, against
10,034 and 10,183 body lines. The file grows while the bodies shrink because each new primitive is
...
8,629 of 10,183 body lines. That
