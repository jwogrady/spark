...
| `domain-semantics` | 66 | 67 | 6,809 | 6,952 | owns a rule about what the facts mean |
...
Module count goes 3 to 4, adding `facts.sh`. The runtime holds 275 functions and 11,936 body lines, against
249 and 10,034 before: +26 functions, +1902 body lines.
...
|---|---|---|---|
| `plugins/spark/bin/spark` | 8,938 | 8,981 | +43 |
...
**12,166 lines before, 14,663 after (+2497)**, against
10,034 and 11,936 body lines. Both grow: this tree adds runtime rather than only redistributing it, and the body lines say so rather than being read out of the file total.
...
9,301 of 11,936 body lines. That
...
- **No cleanup-only refactor became a rewrite** — 28 function(s) added, 2 removed, +1902 body lines — the shape of an increment, not of a restructuring.
