...
| `source-collection` | 86 | 94 | 1,754 | 2,223 | reads a source of truth (git, gh, the filesystem) and returns it unjudged |
...
Module count goes 3 to 4, adding `facts.sh`. The runtime holds 274 functions and 11,627 body lines, against
249 and 10,034 before: +25 functions, +1593 body lines.
...
| `plugins/spark/lib/facts.sh` | 0 | 2110 | +2110 |

**12,166 lines before, 14331 after (+2165)**, against
10,034 and 11,627 body lines. Both grow: this tree adds runtime rather than only redistributing it, and the body lines say so rather than being read out of the file total.
...
9,147 of 11,627 body lines. That
