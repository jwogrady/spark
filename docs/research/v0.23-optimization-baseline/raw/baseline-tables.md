...
| reviewer verdicts (exact-HEAD, trusted login) | 16 | 32 | GitHub REST, derived.json |
| reviewer finding bullets (raw) | 50 | 80 | GitHub REST, derived.json |
| writer top-level PR comments | 29 | 46 | GitHub REST, derived.json |
| writer comment chars | 123,211 | 92,078 | GitHub REST, derived.json |
...
| 32 | cdc04a5 | PASS | 4 | bench-memo.sh | 18 | 480 | 16 | 15 | 1 | 0 | 0 | 1/0 | 0 | 4 | 1,743,036 |
...
| DUP | duplicated-semantic drift (two surfaces disagree) | 7 (14%) | 17 (22%) |
| STALE | stale / reconstructed-state defect | 3 (6%) | 0 (0%) |
| TEST | test-harness / fixture / instrument defect | 2 (4%) | 36 (47%) |
| GOV | governance / specification / evidence-contract ambiguity | 6 (12%) | 8 (10%) |
| **total classified** | | 50 | 76 |
| of which repeats of an earlier finding (same lineage, unfixed or partially fixed) | | 8 | 11 |

## T4 — Reviewer-cited files by round (revisit concentration)

- PR #727: `plugins/spark/lib/execution.sh` cited in 15/16 rounds; `tests/test-merge-authority.sh` cited in 8/16 rounds; `docs/adr/0032-bounded-increment-merge-authority.md` cited in 2/16 rounds; `plugins/spark/docs/reference/cli.md` cited in 2/16 rounds; `ship/SKILL.md` cited in 1/16 rounds
- PR #724: `tests/test-hot-path-memo.sh` cited in 20/32 rounds; `tests/bench-memo.sh` cited in 18/32 rounds; `docs/ops/execution-configuration-surface.md` cited in 14/32 rounds; `.spark/preferences.json` cited in 2/32 rounds; `.spark/state.json` cited in 1/32 rounds
