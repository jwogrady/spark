...
Observed 2026-09-07 against `master` `76a33faba258`, from the live milestone list
(`github:jwogrady/spark/milestones`, read by `spark governance validate`); every
per-milestone statement below is as of that observation.
