...
# build — Stage 3 of the Spark lifecycle

`Ideate → Plan → Generate → Solve → Ship`

Build implements exactly one issue. Its job is to turn acceptance criteria into
working code on a branch — nothing wider.
